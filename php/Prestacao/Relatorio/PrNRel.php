...
$QueryString = "SELECT func.numcad,
                func.nomfun,
                func.titred,
                IsNull (abpr.qtdkm,0) as qtdkm,
                IsNull (abpr.vlrpre,0) as vlrpre,
                IsNull (stts.dessts,'Nao Aberto') as Status
         From tVTRHfunc func  Left Join tPROSabpr abpr on 
                abpr.numloc = func.numloc And abpr.matfun = func.numcad
                Left Join tPROSabpl abpl on abpl.numseq = abpr.seqpla 
                And datepart (Year, abpr.datpre)  = datepart (Year, Getdate())
                And datepart(Month, abpr.datpre) = datepart (Month, Getdate())
                Left Join tPROSstts stts on stts.numsts = abpr.stspre
...
$html = '<html>' .
                ...
                '<tr><td colspan="5" height="60" align="center" cellpadding="75" style="font-size: 20px;font-family:Arial;">RELAT&Oacute;RIO DE PRESTA&Ccedil;&Atilde;O N&Atilde;O REALIZADOS</td></tr>' .
                '</table>' .
                '</td></tr>'.
                ...
                '<td WIDTH="100">Cargo</td><td WIDTH="100">KM</td><td WIDTH="150">Valor da Presta&ccedil;atilde;o</td><td WIDTH="100">Situa&ccedil;&atilde;o</td>' .
                '</tr>' .
                '</thead>'.
                '<tbody>';
