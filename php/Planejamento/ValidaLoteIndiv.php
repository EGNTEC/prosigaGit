...
foreach ($data as $key) {
  ...
  $queryLote = mssql_query($strLote);
    ...
    if($numseq==9999){
       ...
       $strquery = "UPDATE tproslote set stslot=1 WHERE numseq='$numseq'";
        //var_dump($strquery);
