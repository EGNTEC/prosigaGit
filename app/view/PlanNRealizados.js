...
Ext.define('desloc.view.PlanNRealizados', {
    //renderTo: Ext.getBody(),
    extend: 'Ext.window.Window',
    alias: 'widget.planR',
    title: 'Planejamentos Não Realizados',
    height: 550,
    width: 920,
    //x: 5,
    //y: 10,
    ...
    items: [{
        ...
        },
        {
            ...
            layout: 'fit',
            store: Ext.create('desloc.store.PlanNRealS'),
            features: [{
                ftype: 'summary'
            }],
            //autoScroll:true,
    ...
    dockedItems: [{
        ...
        items: [{
            ...
            },
            {
                ...
                iconCls: 'icon-excel',
                hrefTarget: "_blank",
                href: 'https://novoprossiga.inec.org.br/php/Planejamento/gerExcelPNR.php',
                listeners: {
                    click: function() {
